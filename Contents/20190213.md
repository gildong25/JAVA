...
public static void main(String[] args) {
	...
	while(true) {
		while(true) {
			System.out.print("월을 입력해주
}
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2ODQ2MjQwMCwtODU5Njk3NTg3LDEzNz
c1MDE2MDksMTAzOTI1MDI3OSwtNTcwMDQwNTIsLTgzNTUyNjAw
OCwtMTM2Mjk1OTM2NywxMjI4NzY0MzgyLDYzNTg4MjcyMSwtMT
U0OTc2NDc5MywtMjA4ODc0NjYxMl19
-->