...
//		float num2 = (float)sum; // 명시적 형변환
		...
		average = sum / (float) n;	// 형변환
	//	average = sum / (n*1.0f);	// 실수를 곱해서 형변환
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM5ODg4Mjc1NiwtMTMwODcxMzE2NCwxND
A2MjY1MTI1LDE0NjUyMDE3NywtMzc0NDA5MzAsLTE0MjAwNzcw
NDhdfQ==
-->